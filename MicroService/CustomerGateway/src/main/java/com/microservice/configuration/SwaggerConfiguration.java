...
public class SwaggerConfiguration {
    ...
    public ApiInfo metadata() {
        return new ApiInfoBuilder()
            .title("ws-sample-document")
            .description("Service that implement tourico api bridge integration")
            .version("1.0.0")
            .contact(new Contact("ApiBridge Team", "http://www.sabre.com", "apibridgedt@sabre.com"))
            .build();
    }
